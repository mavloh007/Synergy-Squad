...
df, low_inventory_threshold, high_inventory_threshold = generate_inventory(df)
...
pricing_results = dynamic_pricing(lstm_results, low_inventory_threshold, high_inventory_threshold)
